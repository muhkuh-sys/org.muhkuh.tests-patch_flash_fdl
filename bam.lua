...
atEnv.DEFAULT.atVars.PROJECT_VERSION = { "1", "0", "0" }
...
local atArtifacts =
{
...

  {
    ...
    strModule = 'patch_flash_fdl',
    strArtifact = 'patch_flash_fdl',
    ...
    archive = {
      structure = {
        ...
        'installer/org.muhkuh.tests-patch_flash_fdl/install.lua',
        'installer/org.muhkuh.tests-patch_flash_fdl/install_testcase.lua'
      },
      extensions = {'tar', 'xz'},
      format = 'tar',
      filter = {'xz'}
    ...
    templates = {
      artifact_configuration = 'installer/org.muhkuh.tests-patch_flash_fdl/patch_flash_fdl.xml',
      pom = 'installer/org.muhkuh.tests-patch_flash_fdl/pom.xml'
    },
